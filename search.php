...
?><hr/>     
 <div class="c_main_title">
                          <h6 class="col-12">Search : <?php echo $search; ?></h6>
                    </div>
           ...
           <?
                        ...
                        {
                            $search = $_GET['search'];
                            $sql="SELECT * FROM product where post ='approved'  AND product_name LIKE '%$search%' OR product_desc LIKE  '%$search%'  OR product_cat LIKE  '%$search%' ORDER BY date DESC;";
                            ...
                            $sql="SELECT *,product_id as id,(SELECT file_name FROM product_images WHERE product_id = id LIMIT 1) AS img FROM product AS tbl WHERE post='approved' AND product_name != '' LIMIT 10;";
                        }
                        

                             if(empty( $categories_id))
                             {
                                 $sql="SELECT * FROM product where post ='approved'  AND product_name LIKE '%$search%' OR product_desc LIKE  '%$search%' ORDER BY date DESC;";
                             }
                             else
                             {
...
?>
                     ...
                     <a class="card_card_dev1" >
<div class="card2_card_dev1 ">
