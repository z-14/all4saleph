...
else
{
  $img="https://wallpaperplay.com/walls/full/2/a/c/58118.jpg";
                                ...
                                ?>
<div  onClick="javascript:ajaxpagefetcher.load('window','seller_person.php?cat_name=<?echo $productName;?>&cat_type=<?echo $_GET["cat_type"];;?>&img=<?echo $img;?>', true),HideMenu()" style="margin-left: 0px; margin-bottom: 5px; margin-right: 0px; padding-right: 5px; padding-left: 5px;"  class="col-lg-3 col-sm-6 m-20 ">
