                            ...
                            <div class="col-lg-8" style="padding-left: 0px; margin-top: 28px;"><div class="list-group">
                               <div class="list-group">
                                   ...
                                   <div class="input-group input-group-sm mb-3">
                                        ...
                                        <input type="text" class="form-control" placeholder="Search Here" name="" onchange="javascript:ajaxpagefetcher.load('all', 'merchant_inventory_product_searched.php?sortBy='+sorter.value+'&search='+this.value, true)">
                                        <button class="input-group-text" style="background-color: #33a0e8"><i class="icon-magnifier" style="color: #fff; "></i></button>
                                    </div> 
                      </div></div>
                  </div>
              </div>
