...
<div class="col-lg-6">
                 <div class="input-radio">
                  <input type="radio" onClick="javascript:ajaxpagefetcher.load('field','field.php?sub_name=<?echo $sub_name;?>&cat_name=<?echo $cat_name;?>&other=<?echo $other;?>&detail=full', true),HideMenu()" name='price_id' id="low" value="high" checked >
...
<div class="col-lg-6 checkbox-filte">
        <div class="input-radio">
                  <input type="radio" onClick="javascript:ajaxpagefetcher.load('field','field.php?sub_name=<?echo $sub_name;?>&cat_name=<?echo $cat_name;?>&other=<?echo $other;?>&detail=basic', true),HideMenu()" name='price_id' id="high" value="high" >
 ...
 else if($_GET["detail"]== "basic")
 {
?>
  <div class="col-lg-6">
                 <div class="input-radio">
                  <input type="radio" onClick="javascript:ajaxpagefetcher.load('field','field.php?sub_name=<?echo $sub_name;?>&cat_name=<?echo $cat_name;?>&other=<?echo $other;?>&detail=full', true),HideMenu()" name='price_id' id="low" value="high" >
                  <label class="deo_label" for="low">
                    <span class="deo_checkbox"></span>
                   Full Details
                    <small></small>
...
<div class="col-lg-6 checkbox-filte">
        <div class="input-radio">
                  <input type="radio" onClick="javascript:ajaxpagefetcher.load('field','field.php?sub_name=<?echo $sub_name;?>&cat_name=<?echo $cat_name;?>&other=<?echo $other;?>&detail=basic', true),HideMenu()" name='price_id' id="high" value="high" checked>
                  <label class="deo_label" for="high">
                    <span class="deo_checkbox"></span>
                    Basic Details
                    <small></small>
