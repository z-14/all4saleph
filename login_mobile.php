                    ...
                    <div class="row">
                        <div class="col-lg-8">
                            <div class="login_title">
                                ...
                                <div class="login_form row">
                                <div class="col-lg-6 form-group">
                                    <input class="form-control" type="text" placeholder="Username" id="u" onchange="addtoPost('&username='+this.value)" onclick="anchorIt(this.id)">
                                </div>
                                <div class="col-lg-6 form-group">
                                    <input class="form-control" type="password" id="p" placeholder="Password" onchange="addtoPost('&password='+this.value)" onclick="anchorIt(this.id)" >
                                </div>                              
                                 <div class="col-lg-6 form-group">
                                    <button class="add_cart_btn  btn-block" onClick="postItGoTo('processlogin_mobile.php','home.php')">Login</button>
                                </div>
                                
                                <div class="col-lg-6 form-group">
                                    <button class="add_cart_btn  btn-block" onClick="getdataFB()">FB Login </button>
                                </div>
                                </div>
