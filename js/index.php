...
?>
 ...
 <style>       
        body{
/* Permalink - use to edit and share this gradient: http://colorzilla.com/gradient-editor/#fcc500+0,ffffff+5,ffffff+17,ff0000+33,f9f9f9+49,ffffff+74,fcc500+100 */
background: #fcc500; /* Old browsers */
background: -moz-linear-gradient(top, #fcc500 0%, #ffffff 5%, #ffffff 17%, #ff0000 33%, #f9f9f9 49%, #ffffff 74%, #fcc500 100%); /* FF3.6-15 */
background: -webkit-linear-gradient(top, #fcc500 0%,#ffffff 5%,#ffffff 17%,#ff0000 33%,#f9f9f9 49%,#ffffff 74%,#fcc500 100%); /* Chrome10-25,Safari5.1-6 */
background: linear-gradient(to bottom, #fcc500 0%,#ffffff 5%,#ffffff 17%,#ff0000 33%,#f9f9f9 49%,#ffffff 74%,#fcc500 100%); /* W3C, IE10+, FF16+, Chrome26+, Opera12+, Safari7+ */
filter: progid:DXImageTransform.Microsoft.gradient( startColorstr='#fcc500', endColorstr='#fcc500',GradientType=0 ); /* IE6-9 */
