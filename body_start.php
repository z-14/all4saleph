...
?>
<div id="art_header" style="" onclick="showArtheader()">

<div id="cute_icons">

<div id="art_search"><input id="art_search_input" type="text" placeholder="Search" onchange="javascript:ajaxpagefetcher.load('window', 'search.php?search='+this.value, true)"> </div>
...
<div id="art_tabs">
	...
	<div class="art_tabs_title" onClick="javascript:ajaxpagefetcher.load('window','categories_main_holder.php', true)" >Categories</div>
...
?>
<div id="top_cute_menu">
<div class="top_cute_menu_icon" id="backbutton" onclick="backButton()"></div>

<?
if(!isset($_SESSION["u_u"])){
?>
<div  class="top_cute_menu_icon" id="fblogindiv">
<fb:login-button scope="public_profile,email" onlogin="checkLoginState();">
</fb:login-button>
</div>
<div id="fbstatus" class="top_cute_menu_icon" style="padding: 5px;"></div>
<?
} else{
?>
<div id="fbstatus" class="top_cute_menu_icon" style="padding: 5px;"></div>
