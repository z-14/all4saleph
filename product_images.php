                        ...
                        while ($row_img = $get_res->fetch_assoc()) 
                          {
                            ...
                            ?>
                             <div style="margin-top: 5px;  margin-bottom: 10px;padding-left: 5px; padding-right: 5px;"  class="single-blog-post style-2 col-lg-3 col-sm-3 deo_img">
                                <!-- Post Thumb -->
                                <div class="H-p">
...
<button onClick="javascript:ajaxpagefetcher.load('window','select_categories.php?<?echo $_SESSION["product_id"];?>', true),HideMenu()" class="add_cart_btn" style="margin-bottom: 50px; float: right; float: right;">Next: Choose a category</button>
