...
<div class="col-md-12 col-lg-12">
 <button style="margin-top: 10px;" class="button full-width button-sliding-icon ripple-effect" onClick="postIt('product_edit_reg.php?product_id=<?echo $_GET["product_id"];?>'),hidePT()">Save</button>
