...
<div class="col-md-12 col-lg-12">
 <button style="margin-top: 10px;" class="add_cart_btn  btn-block" onClick="postIt('product_edit_reg.php?product_id=<?echo $_GET["product_id"];?>'),hidePT()">Save</button>
...
<div class="form-group col-lg-12"id="meet"   >
    ...
    <input type="text" id="ram"  value="<?echo $location;?>" onchange="addtoPost('&location='+this.value)"  oninput="showPass('storage: '+ this.value);" onclick="showPass('Model: '+this.value),anchorIt(this.id),toggleClass(this.id);" class="form-control" placeholder="" name="" />
    </div>
<?
}
else
