...
$totalRowCount = 3;
 $sql="SELECT * FROM product where product_name !=''and product_cat = '$cat' and deleted !='yes' and seller_type = '$type' and duplicate_no = 0 ";
...
?>
      ...
      <?}
        ...
        {
?>
 <img  onclick="javascript:ajaxpagefetcher.load('window','login.php')" src="<?echo getProductImage($row['product_id']);?>" alt="">
