...
?>
<div id="fluid_banner" style="background: url('') "></div>
...
<div style="text-align: center;"><button href="#" class="button button4" onclick="UnliScrollLoadProduct()">Load more</button></div>
<?
*/
}
?>
...
<div id="UnliLoading" style="width: 100%; height: 10px; z-index: 100;"><center><img src="loading.gif" width="30"></center></div> 
*/
} 
?>
