...
<input id="art_search_input" type="text" value="<?echo $_GET["search"];?>" placeholder="Search here" name="" onchange="javascript:ajaxpagefetcher.load('window', 'admin_user_list.php?search='+this.value, true)" style="color: gray; border: 1px solid red;">    
...
<?
$sql="SELECT * FROM user_profile where user_profile_id !=0 ";
...
function  wistlist($u_id,$u_u,$imageURL, $firstName,$surname,$merchant_type,$email,$telephone,$address)
{
 ...
 <div class="col-lg-12 p-3 cardlist">
                      ...
                      <div class="row">
                        ...
                        <div class="col-8 col-lg-9 col-xl-10">
                          ...
                          <div class="cartviewprice d-block">
                           ...
                           <div class="cartviewprice d-block">
                            <span class="oldamt">Reports : </span>
                          </div>
     ...
     <button  onClick="rejectIt('window','admin_merchant_application_action.php?user=yes-<? echo $u_id;?>','admin_user_list.php','Are really sure you want to remove this User?')"   class="product_heart">
