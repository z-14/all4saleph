...
switch ($sortBy) {
	...
	case 'Approved':
	$sql="SELECT * FROM `product`  where u_id = '$u_id' AND product_name != '' And post='approved'  ";
	$result = $conn->query($sql);
	break;

	case 'Pending':
	$sql="SELECT * FROM `product`  where u_id = '$u_id' AND post=''   ";
	$result = $conn->query($sql);
	break;

	case 'Declined':
	$sql="SELECT * FROM `product`  where u_id = '$u_id' AND product_name != '' And post='declined'  ";
	$result = $conn->query($sql);
	break;
